...
namespace SampleCaptura
{
    ...
    public class CaptureWebcam : ISampleGrabberCB, IDisposable
    {
        ...
        /// </summary>
        public System.Drawing.Size Size => _videoInfoHeader != null ? new System.Drawing.Size(_videoInfoHeader.BmiHeader.Width, _videoInfoHeader.BmiHeader.Height) : System.Drawing.Size.Empty;
        ...
        readonly MainWindow _maiWin;

        public CaptureWebcam(Filter VideoDevice, Action OnClick, IntPtr PreviewWindow, MainWindow maiWin)
        {
            _videoDevice = VideoDevice ?? throw new ArgumentException("The videoDevice parameter must be set to a valid Filter.\n");

            //修改自Captura源码，将WinForm代码改为适用于WPF
            _maiWin = maiWin;
            //获取handle
            IntPtr hwnd = ((HwndSource)PresentationSource.FromVisual(_maiWin)).Handle;
            _previewWindow = PreviewWindow != IntPtr.Zero ? PreviewWindow : hwnd;
        ...
        public DrawingImage GetFrame()//IBitmapLoader BitmapLoader = null)
        {
            ...
            try
            {
                ...
                return CreateBitmapBgr32(new System.Drawing.Size(width, height), address, -stride);
            }
            finally
            {
                handleObj.Free();
        ...
        public DrawingImage CreateBitmapBgr32(System.Drawing.Size Size, IntPtr MemoryData, int Stride)
        {
            Bitmap bmp = new Bitmap(Size.Width, Size.Height, Stride, System.Drawing.Imaging.PixelFormat.Format32bppRgb, MemoryData);
        ...
        void RenderGraph()
        {
            ...
            if (_wantPreviewRendered && !_isPreviewRendered)
            {
                ...
                hr = _videoWindow.put_Owner(hwnd);

                _videoWindow.put_MessageDrain(hwnd);
                ...
                hr = _videoWindow.put_WindowStyle(DirectShowLib.WindowStyle.Child | DirectShowLib.WindowStyle.ClipChildren | DirectShowLib.WindowStyle.ClipSiblings);
